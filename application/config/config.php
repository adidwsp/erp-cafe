...
$config['sess_expiration'] = 0; // dalam detik (2 jam). 0 = session cookie (sampai browser close)
$config['sess_save_path'] = 'ci_sessions';
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 300; // regenerate session id tiap 5 menit
$config['sess_regenerate_destroy'] = TRUE; // aman untuk mencegah session fixation
...
// encryption key (wajib jika pakai enkripsi / security helper)
$config['encryption_key'] = 'ajhoqiflsjPPHPnhPZDASFINkjhfdljapohai';
